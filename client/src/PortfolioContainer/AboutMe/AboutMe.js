...
export default function AboutMe(props) {
  ...
  const SCREEN_CONSTANTS = {
    description:
      "Hello! I'm Bridgett, and I'm a frontend developer living in Spokane, WA. I enjoy building beautiful websites using HTML, CSS, and JavaScript. I especially enjoy collaborating with others and working towards common goals. I'm seeking a junior frontend developer position where I can contribute meaningfully and grow alongside of a team. I recently graduated from Nucamp's Frontend Coding Bootcamp, and I'd love for you to check out my portfolio projects to see if I might be a good fit for your company. When I'm not coding, I'm usually spending time with friends and family, playing board/card games, reading, and learning new skills/hobbies. Right now, I'm learning pottery wheel basics and how to track and photograph the Aurora Borealis.",
    skills: {
      bullets: [
